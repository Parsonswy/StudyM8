<?php
  class FileAction{
    ...
    private function initGoogleClient(){
      ...
      $this->_Google_Client->setAuthConfig("/var/www/html/exAPIS/GAPI/client_secret_714276037632-o78r4g32of31cbpaa59jd279vg5sbrqm.apps.googleusercontent.com.json");
